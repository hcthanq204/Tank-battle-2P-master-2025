...
void Game::renderCredits() {
    ...
    // 1. Render hovaten
    SDL_Surface* tenSurface = TTF_RenderText_Solid(titlefont, "HOANG CONG THANG", hovaten);
    ...
    // 2. Render mssv
    SDL_Surface* mssvSurface = TTF_RenderText_Solid(font, "24022832", mssv);
    ...
    SDL_Surface* lhpSurface = TTF_RenderText_Solid(font, "INT2215-6 Nhom 2", lhp);
